...
for ($j=1; $j<=221; $j++){ //2845
	
	$strCookie = 'PHPSESSID=uki9rdjvudgsiavn7u6he0g4q0; path=/';      // rqt8es8bfomlnghq0nfu2fnof1   -  вот это взять из браузера
	//$curl_handle = curl_init('http://www.fsrar.ru/licens/reestr?region=61&address=&lictype=799&page='.$j);
	$curl_handle = curl_init('http://www.fsrar.ru/frap/frap?regnum=&zaivitel=&name_prod=%D0%92%D0%B8%D0%BD%D0%BD%D1%8B%D0%B9+%D0%BD%D0%B0%D0%BF%D0%B8%D1%82%D0%BE%D0%BA&page='.$j);
